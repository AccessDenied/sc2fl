<script type="text/javascript" src="<?=base_url().'application/scripts/teamleagues/match.js';?>"></script>
<link rel="stylesheet" type="text/css" href="<?=base_url().'application/css/teamleagues/match.css';?>" />
<div id="breadcrumb"><?=anchor('/', 'Home');?> > <?=anchor('teamleagues/league/'.$teamLeague->get_id(), $teamLeague->get_name());?> > <?=$match->get_name();?></div>
<div class="match">
	<div id="teams">
